...
create table tb_paginas(
    ...
    numero_acessos int default 0 not null,
...
INSERT INTO tb_paginas (cod_pagina, titulo, conteudo_pagina, data_hora_criacao, numero_acessos, esta_ativa, cod_usuario_criador)
VALUES
    (1, 'Vício em Álcool', '<html><body><h1>Vício em Álcool</h1><p>O vício em álcool é uma condição...</p></body></html>', '2023-10-11 12:00:00', 1000, 1, 1),
    (2, 'Vício em Tabaco', '<html><body><h1>Vício em Tabaco</h1><p>O tabagismo é uma dependência...</p></body></html>', '2023-10-11 12:15:00', 800, 1, 10),
    (3, 'Vício em Drogas Ilícitas', '<html><body><h1>Vício em Drogas Ilícitas</h1><p>O abuso de substâncias ilícitas...</p></body></html>', '2023-10-11 12:30:00', 1200, 1, 1),
    (4, 'Compulsão Alimentar', '<html><body><h1>Compulsão Alimentar</h1><p>A compulsão alimentar é um distúrbio...</p></body></html>', '2023-10-11 12:45:00', 900, 0, 10),
    (5, 'Jogo Patológico', '<html><body><h1>Jogo Patológico</h1><p>O jogo patológico, ou ludomania...</p></body></html>', '2023-10-11 13:00:00', 750, 1, 1);
...
-- 3. Média da idade de pessoas que fizeram um relato sobre algum vício em específico.
